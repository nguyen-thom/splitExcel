...
import nvt.slpit.com.service.SliptExcelService;
...
@Slf4j
@AllArgsConstructor
public class SliptServiceImpl extends SwingWorker<Integer, String> implements SliptExcelService {

    private String input;
    private String folerOutput;
    ...
    @Override
    public int sliptExcelFile(String input, String folderOutput, String templateFile, int startRow) {
    ...
    protected Integer doInBackground() throws Exception {
        return sliptExcelFile(input, folerOutput, templateFile, startRow);
    }
